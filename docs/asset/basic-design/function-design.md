...
|---|---|
| 文書ID | BD-03 |
| 版数 | V1.2（2026-09-04・D-3 回写：F-20/F-24/F-25/F-26 状態列更新。前版 V1.1＝ドラフト・雛形準拠・2026-09-03 C-2 修订） |
| 作成日 | 2026-08-31 |
...
- 状態表記：✅ 既存実装・実装済｜🔵 P0 計画（未実装）｜⚪ P1。**本書の対象機能（F-20／F-24／F-25／F-26）は 2026-09-02〜09-04 に実装済**（F-20：SF 側受入口 6b9d970＋Booking 側送信 `ProjectionSenderService` 3d88923・F-24：SF 側 Apex 受付 S-5〔`BookingSiteController`〕・F-25：S-4〔`BookingCommandQueueable`〕＋Booking 側 B-2/B-3 8581f50・F-26：S-4 バージョンゲート付き書き戻し）。F-24 の LWC 画面側のみ P0-4。
...
## 7. F-24：キャンセルコマンド受理（部分実施・2026-09-04：P0-3 Apex 側済〔`BookingSiteController`・S-5〕・P0-4 LWC 残）
