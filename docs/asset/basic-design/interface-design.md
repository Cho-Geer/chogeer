...
|---|---|
| 文書ID | BD-09 |
| 版数 | V1.2（2026-09-05・P0-4 Step 5 回写：§5 未決 3 に NC β 偏差注記〔一次性隧道・公網化＝P0-5〕。前版 V1.1＝ドラフト・2026-09-03 C-2 修订） |
| 作成日 | 2026-08-31 |
...
| 予期しない障害 | 500 等 | — | 一時的障害に準じた扱い（**確定 2026-09-02＝429/503/timeout 同列・上限内リトライ→到達で FAILED・CHK-02 C-5**。その他未知応答も同扱い） |
...
| 2 | 【決定済 2026-09-02】リトライ上限＝2 回（初回含め総 3 試行）・間隔＝即時（Queueable 連鎖再 enqueue・DD-03 周期処理追加なし制約）・NextAttemptAt＝再実行予定時刻の記録（CHK-02 C-5） | 決定済み（2026-09-02） |
| 3 | 【決定済 2026-09-02】NC 最終指向＝booking-deploy 公網 HTTPS（CHK-02 C-1・BD-01 §7-1 と同源）。S-2 仮値許容・P0-4 実リンク検証前にデプロイ・切替 **【追記 2026-09-05・拍板 β】**P0-4 実リンク検証（MV-08・手順書 7.2）は**一次性 cloudflared 隧道**で実施済み（NC metadata は Url 値非記録＝版庫漂移なし・当日 URL は CHK-03 §9 登記）。**公網化＝P0-5 へ繰り越し** | 決定済み（2026-09-02／β 偏差追記 2026-09-05） |
