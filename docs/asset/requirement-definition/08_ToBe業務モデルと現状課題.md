...
|---|---|
| 文書ID | RD-08 |
| 版数 | V1.2（2026-09-05・P0-4 Step 5 回写：§4 真実性の注記を実装済み状態へ更新。前版 V1.1＝ドラフト・独立再レビュー指摘反映） |
| 作成日 | 2026-08-31 |
...
> 真実性の注記：To-Be のうち動的 provisioning 等（ISS-08・P1）は設計目標である。投影・コマンド・LWC は実装済み（P0-2〜P0-4）・実機検証済み（2026-09-05・MV-01〜03/07/08）。検証が済んでいない範囲を「実現済み」と表現することはしない。
